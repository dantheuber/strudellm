...
// Load dirt-samples (kick, hats, claps, noise...) over the network
...
// ---- harmonic material ---------------------------------------------
const padChords = '<[d3,f3,c4,e4] [a#2,d3,f3,a3] [g2,a#2,d3,f3] [a2,c3,e3]>'
...
const arpPattern =
  '<[d4 a4 d5 a4 f5 d5 a4 f4 d4 a4 d5 a4 f5 e5 c5 a4]' + // Dm
  ' [a#3 f4 a#4 f4 d5 a#4 f4 d4 a#3 f4 a#4 f4 d5 c5 a4 f4]' + // Bb
  ' [g3 d4 g4 d4 a#4 g4 d4 a#3 g3 d4 g4 d4 a#4 a4 f4 d4]' + // Gm
  ' [a3 a4 a3 a4 a3 a4 a3 a4 a3 a4 a3 a4 a3 a4 a3 a4]>' // A pump
...
$: note(padChords)
  ...
  .room(0.85)
  .mask('<1@8 1@8 1@16 1@16 1@8 1@24 1@8 0@8>')
